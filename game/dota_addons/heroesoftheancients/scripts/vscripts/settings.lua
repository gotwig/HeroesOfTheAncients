...
CAMERA_DISTANCE_OVERRIDE = 1240.0       -- How far out should we allow the camera to go?  1134 is the default in Dota
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 82, 226, 255 }  --    Blue
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 255, 26, 0 }   --    Red
